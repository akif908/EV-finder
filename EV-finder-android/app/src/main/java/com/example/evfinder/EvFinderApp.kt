...
class EvFinderApp : Application() {
    ...
    override fun onCreate() {
        ...
        // osmdroid: OpenStreetMap's tile servers block apps that don't identify
        // themselves (403 "Access blocked"). Send a policy-compliant user agent
        // and keep the tile cache private to this app.
        org.osmdroid.config.Configuration.getInstance().apply {
            userAgentValue = "EV-Finder-Android/1.0 (university course project; " +
                "contact: $packageName)"
